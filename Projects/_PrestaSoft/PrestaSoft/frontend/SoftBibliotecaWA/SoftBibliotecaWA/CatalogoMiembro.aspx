<%@ Page Title="Catálogo" Language="C#" MasterPageFile="~/MaestroMiembro.Master" AutoEventWireup="true" CodeBehind="CatalogoMiembro.aspx.cs" Inherits="SoftBibliotecaWA.CatalogoMiembro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="barraBusqueda d-flex flex-column align-items-start mx-auto">
        <div class="input-group mb-3">
            ...
            <buttom type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#busquedaAvanzadaModal" style="text-decoration: none; color: #ffffff;">
                Búsqueda avanzada
    ...
    <div id="contenido" class="contenidoNormal mx-3" style="padding-top: 100px; padding-right: 40px;">
        <asp:Label ID="lblCantidadPublicaciones" runat="server" CssClass="mt-2"></asp:Label>
        <div class="row">
                ...
                <ItemTemplate>
                    <div class="col-md-6 mb-3">
                        <div class="publicacion d-flex align-items-start border rounded p-2" style="max-width: 1000px; height: 200px;">
                            ...
                            <div>
                                <h4 class="mb-1">
                                    <a href='<%# "DetallePublicacion.aspx?id=" + Eval("idPublicacion") + "&tipo=" + (Container.DataItem is SoftBibliotecaBO.ServicioWeb.tesis ? "tesis" : "libro") %>' class="text-dark" style="text-decoration: none;">
                                        <%# Eval("titulo") %>
                                    </a>
                                </h4>
                                <p class="mb-0">Descripción: <%# Eval("descripcion").ToString().Length > 275 ? Eval("descripcion").ToString().Substring(0,275) + "..." : Eval("descripcion") %></p>
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
