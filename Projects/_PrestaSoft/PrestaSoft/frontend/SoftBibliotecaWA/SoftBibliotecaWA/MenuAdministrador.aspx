<%@ Page Title="Inicio - Administrador" Language="C#" MasterPageFile="~/MaestroAdministrador.Master" AutoEventWireup="true" CodeBehind="MenuAdministrador.aspx.cs" Inherits="SoftBibliotecaWA.MenuAdministrador" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="gray-bar fixed-bar">
            ...
            <asp:Button ID="btnConsorcio" runat="server" Text="Consorcios" CssClass="btn btn-gold" OnClick="MostrarConsorcios" />
    ...
    <div class="container">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lbEliminarUniversidad" runat="server" CommandArgument='<%# Eval("idUniversidad") %>' OnClick="lbEliminarUniversidad_Click" OnClientClick="return confirm('¿Está seguro de que desea eliminar esta universidad?');" CssClass="btn btn-danger btn-sm">
                                            Eliminar
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <div id="TablaBiblioteca" runat="server" visible="true">
            ...
            <!-- Sección CONSORCIO -->
            <div id="TablaConsorcio" runat="server" visible="true">
            <div class="card mb-4">
                <div class="card-header">
                    <h2>CONSORCIO</h2>
                </div>
                <div class="card-body">
                    <!-- BOTÓN DE INGRESAR REGISTRO Y GRIDVIEW -->
                    <asp:Button ID="btnAbrirModalConsorcio" CssClass="btn btn-success mb-3" runat="server" Text="Ingresar Consorcio" OnClick="btnAbrirModalConsorcio_Click" />

                    <!-- GRIDVIEW DE DATOS -->

                    <div style="overflow-x: auto;">
                        <asp:GridView ID="GV_Consorcios" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False" DataKeyNames="idConsorcio">
                            <Columns>
                               
                                <asp:BoundField DataField="CIF" HeaderText="CIF" />
                                <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbEditarConsorcio" runat="server" CommandArgument='<%# Eval("idConsorcio") %>' OnClick="lbEditarConsorcio_Click" CssClass="btn btn-primary btn-sm">
                                            Editar
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="lbEliminarConsorcio" runat="server" CommandArgument='<%# Eval("idConsorcio") %>' OnClick="lbEliminarConsorcio_Click" OnClientClick="return confirm('¿Está seguro de que desea eliminar este consorcio?');" CssClass="btn btn-danger btn-sm">
                                            Eliminar
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <!-- Modal para Insertar/Editar Consorcio -->
                    <div class="modal fade" id="modalConsorcio" tabindex="-1" role="dialog" aria-labelledby="modalConsorcioLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 id="modalConsorcioLabel" runat="server" class="modal-title">Consorcio</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <!-- Campos del formulario -->
                                    <div class="form-group">
                                        <asp:Label runat="server" Text="CIF:" AssociatedControlID="txtCIFConsorcio" />
                                        <asp:TextBox ID="txtCIFConsorcio" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <asp:Button ID="btnCancelarConsorcio" CssClass="btn btn-secondary" runat="server" Text="Cancelar" OnClick="btnCancelarConsorcio_Click" />
                                    <asp:Button ID="btnGuardarConsorcio" CssClass="btn btn-primary" runat="server" Text="Guardar" OnClick="btnGuardarConsorcio_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- JavaScript para manejar el modal -->
                <script type="text/javascript">
                    function showModalConsorcio() {
                        $('#modalConsorcio').modal('show');
                    }

                    function hideModalConsorcio() {
                        ...
                        <div style="overflow-x: auto;">
                            <asp:GridView ID="GV_Politicas" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False" DataKeyNames="idPolitica">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="politicasPorReserva.idPoliticaReserva" HeaderText="Código de la política de reservas" />
                                    <asp:TemplateField HeaderText="Acciones">
                                        <ItemTemplate>
